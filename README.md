...
- Solution Архитектор, Ведущий системный аналитик и Fullstack разработчик
...
- [ФИНАМ](https://www.finambank.ru/) – микросервисная архитектура в банке, интеграции с Camunda/Kafka/gRPC
